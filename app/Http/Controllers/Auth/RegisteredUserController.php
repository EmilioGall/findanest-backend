...
class RegisteredUserController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        $request->validate(
            [
                'name' => ['nullable', 'string', 'max:255', 'min:3', 'alpha'],
                'surname' => ['nullable', 'string', 'max:255', 'min:3', 'alpha'],
                'date_of_birth' => ['nullable', 'date', 'before_or_equal:today', 'after_or_equal:' . now()->subYears(100)->toDateString()],
